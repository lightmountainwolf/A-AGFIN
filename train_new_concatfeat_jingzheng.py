...
from classifier_jz2_4096 import Classifier
...
def main():
    ...
    # point_cloud_model.load_state_dict(torch.load(args.model_dir + '/' + args.model + '_best_baseline_point_cloud_modelnew_15' + '.pth'))
