...
from threed_feat_model_attention import POINTCLOUDMODEL
...
parser.add_argument('--test-feat-dir', type=str, default='point_feature_pointnet_connect_withweight_attention13pre.mat')
...
def main():
    ...
    point_cloud_model.load_state_dict(
        torch.load(args.model_dir + '/' + args.model + '_baseline_point_cloud_modelnew'  + '.pth'))
    classifier.load_state_dict(
        torch.load(args.model_dir + '/' + args.model + '_baseline_classifiernew'  + '.pth'))
