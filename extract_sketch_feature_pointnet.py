...
parser.add_argument('--train-datadir', type=str, default='/home/sse316/heng/cgn/datasets/shrec_13/SHREC13_SBR_TRAINING_SKETCHES')
parser.add_argument('--test-datadir', type=str, default='/home/sse316/heng/cgn/datasets/shrec_13/SHREC13_SBR_TESTING_SKETCHES')
...
parser.add_argument('--test-feat-dir', type=str, default='/home/sse316/heng/cgn/extract_features/alex_L2_test_sketch_feature_lee_pointnet.mat')
parser.add_argument('--train-feat-dir', type=str, default='/home/sse316/heng/cgn/extract_features/alex_L2_train_sketch_feature_lee_pointnet_train.mat')
...
def get_test_data(traindir):
    ...
    sketch_data = datasets.ImageFolder(root=traindir, transform=image_transforms)
    dataloaders = DataLoader(sketch_data, batch_size=args.batch_size, shuffle=False,
...
def main():
    ...
    classifier1 = torch.load(args.model_dir + '/' + args.model + '_best_baseline_classifiernew' + '.pth')
