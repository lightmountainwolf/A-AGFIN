...
correct_path='/home/sse316/heng/cgn/datasets/shrec_13/multy_view/'
wrong_path='/home/sse316/heng/cgn/datasets/shrec_13/multy_view/'
...
parser.add_argument('--view-test-datadir', type=str, default='/home/sse316/heng/cgn/datasets/shrec_13/multy_view')
...
parser.add_argument('--view-feat-flie', type=str,
                    default='/home/sse316/heng/cgn/extract_features/alex_L2_test_view_feature_lee.mat',
...
def main():
    ...
    print(top_10_retrieval)
    print("Top 10 result: "+str(top_10_retrieval))
    print("Top 10 result: " + view_paths[801])
    ...
    for i in top_10_retrieval:
        if view_label[i][0]==sketch_label:
            os.mkdir('/home/sse316/heng/cgn/retrieval_result/' + sketch_id + '/' + str(i))
            file=os.path.join(correct_path,view_paths[i],os.listdir(correct_path+view_paths[i])[0])
            shutil.copy(file,'/home/sse316/heng/cgn/retrieval_result/' + sketch_id + '/' + str(i))
        else:
            os.mkdir('/home/sse316/heng/cgn/retrieval_result/' + sketch_id + '/' + str(i))
