...
parser.add_argument('--point_cloud-feat-flie', type=str,
                    default='/home/sse316/heng/cgn/point_feature_pointnet_connect_withweight_4096_jz24096_resnet50.mat',
        ...
        if os.path.isdir(type_folder_path):
            ...
            for test_folder in test_folders:
                ...
                for image_file in image_files:
                    ...
                    file_path = os.path.join('retrieval_result_resnet50', file_name)
