...
from point_cloud_dataset_reader import PointCloudDataSet
...
parser.add_argument('--train-datadir', type=str, default='E:/3d_retrieval/Dataset/Shrec_13/12_views/13_train_sketch_picture')
parser.add_argument('--test-datadir', type=str, default='/home/sse316/heng/cgn/datasets/shrec_13/point_clouds')
...
parser.add_argument('--test-feat-dir', type=str, default='point_feature_pointnet.mat')
...
def get_test_data(traindir):
    ...
    point_cloud_data = PointCloudDataSet(traindir)
...
def main():
    ...
    point_cloud_model = POINTCLOUDMODEL()
    ...
    point_cloud_model.load_state_dict(
        torch.load(args.model_dir + '/' + args.model + '_baseline_point_cloud_modelnew_680'  + '.pth'))
    classifier.load_state_dict(
        torch.load(args.model_dir + '/' + args.model + '_baseline_classifiernew_680'  + '.pth'))
