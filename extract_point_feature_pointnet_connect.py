...
parser.add_argument('--model-dir', type=str,default='/home/sse316/heng/cgn/trained/cfww_4096w')
...
parser.add_argument('--test-feat-dir', type=str, default='point_feature_pointnet_connect_withweight_4096.mat')
...
def main():
    ...
    point_cloud_model.load_state_dict(
        torch.load(args.model_dir + '/' + args.model + '_baseline_point_cloud_modelnew_120'  + '.pth'))
    classifier.load_state_dict(
        torch.load(args.model_dir + '/' + args.model + '_baseline_classifiernew_120'  + '.pth'))
    ...
    for batch_idx, (data, labels,path) in enumerate(trainloader):
        ...
        if args.uncer:
            ...
            x2, logits = classifier.forward(output)
