...
parser.add_argument('--point_cloud-feat-flie', type=str,
                    default='/home/sse316/heng/cgn/point_feature_pointnet_connect_withweight_4096.mat',
...
def main():
    ...
    classifier1 = torch.load(args.model_dir + '/' + args.model + '_baseline_classifiernew_120' + '.pth')
    ...
    sketch_model.load_state_dict(torch.load(args.model_dir + '/' + args.model + '_baseline_sketch_modelnew_120' + '.pth'))
    classifier.load_state_dict(torch.load(args.model_dir + '/' + args.model + '_baseline_classifiernew_120' + '.pth'))
        ...
        if os.path.isdir(type_folder_path):
            ...
            for test_folder in test_folders:
                ...
                for image_file in image_files:
                    ...
                    file_path = os.path.join('retrieval_result_concat_4096', file_name)
