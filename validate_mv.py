...
parser.add_argument('--view-test-datadir', type=str, default='/home/sse316/heng/cgn/datasets/shrec_13/point_clouds')
...
parser.add_argument('--point_cloud-feat-flie', type=str,
                    default='/home/sse316/heng/cgn/alex_L2_test_view_feature_multy_view.mat',
                    help="features flie of view images of 3d models, .mat file")
parser.add_argument('--multy_view-feat-flie', type=str,
                    default='/home/sse316/heng/cgn/alex_L2_test_view_feature_multy_view.mat',
                    help="features flie of view images of 3d models, .mat file")
...
def get_point_cloud_data(point_cloud_feat_flie):
    ...
    point_cloud_feature = point_cloud_data_features1['view_feature']
    point_cloud_label = point_cloud_data_features1['view_labels']
    point_cloud_paths=point_cloud_data_features1['view_paths']
...
def main():
    ...
    classifier1 = torch.load(args.model_dir + '/' + args.model + '_best_baseline_classifier' + '.pth')
    ...
    classifier.load_state_dict(torch.load(args.model_dir + '/' + args.model + '_best_baseline_classifier' + '.pth'))
        ...
        if os.path.isdir(type_folder_path):
            ...
            for test_folder in test_folders:
                ...
                for image_file in image_files:
                    ...
                    file_path = os.path.join('retrieval_result_mv', file_name)
