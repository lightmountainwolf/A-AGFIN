...
parser.add_argument('--test-feat-dir', type=str, default='alex_L2_test_view_feature_point.mat')
...
def main():
    ...
    point_cloud_model.load_state_dict(
        torch.load(args.model_dir + '/' + args.model + '_baseline_point_cloud_modelnew_80'  + '.pth'))
    classifier.load_state_dict(
        torch.load(args.model_dir + '/' + args.model + '_baseline_classifiernew_80'  + '.pth'))
