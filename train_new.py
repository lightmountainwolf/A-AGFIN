...
parser.add_argument('--point-cloud-datadir', type=str, default='/home/sse316/heng/cgn/datasets/shrec_13/point_clouds')
...
def train(sketch_model, view_model, classifier, point_cloud_model, criterion_soft, criterion_am,
    ...
    for batch_idx in range(max(point_cloud_size, sketch_size)):
        ...
        point_cloud_data = point_cloud_data.float().cuda()
...
def main():
    ...
    # point_cloud_model.load_state_dict(torch.load(args.model_dir + '/' + args.model + '_best_baseline_point_cloud_modelnew_79' + '.pth'))
